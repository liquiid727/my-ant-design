...
import type { ThemePresetDefinition } from '../../../themes/types';
import { DEFAULT_COLOR } from '../../../themes/official';
import antDesignLogo from '../../../themes/assets/ant-design.svg';

type PreviewThemeConfig = Pick<ThemePresetDefinition, 'icon' | 'name'> & {
  bgImgDark?: boolean;
};
